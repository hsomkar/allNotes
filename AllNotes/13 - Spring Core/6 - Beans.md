- In Spring, the objects that form the backbone of our application and are managed by the Spring IoC container are called beans. - **Features** of Bean are (in Java): 
