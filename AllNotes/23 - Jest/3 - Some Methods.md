- ![const functions = require(' ./functions'); test('Adds 2 + 2 to equal 4', expect (functions. add(2, 2)) .toBe(4); test( • Adds 2 + 2 to NOT equal expect (functions. add(2, 2)).not.toBe(5); ](Exported%20image%2020250408213957-0.png)
- toBe- To compare
