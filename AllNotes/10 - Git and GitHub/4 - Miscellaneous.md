...
- You can think of the HEAD as the "current branch". When you switch branches with `git checkout origin`, the HEAD revision changes to point to the tip of the new branch.
